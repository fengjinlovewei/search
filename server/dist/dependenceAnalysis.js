...
exports.dependenceAnalysis = void 0;
function dependenceAnalysis(changeFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // 最终依赖结果容器
        const changePagesJson = {};
        // 依赖的全部细节容器
        const changePagesJsonFull = {};
        // 遍历变动的文件
        for (const changePathData of changeFiles) {
            ...
            for (const key of MAP_KEYS) {
                ...
                // 跳过已经过滤的
                if (indexPathData[finedName] !== undefined)
                    continue;
                // 创建一个队列
            ...
            changePagesJson[changePath] = {
                changeType,
                children: current.filter(Boolean),
            };
        }
        // changePagesJson = {
...
exports.dependenceAnalysis = dependenceAnalysis;

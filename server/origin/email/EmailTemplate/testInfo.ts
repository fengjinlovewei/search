...
import { DateFormat, mdParse } from '../../util';
import Search from '../../';
...
async function emailTemplate(
  ...
  const getPageStr = data => {
    ...
    const { head } = mdParse(md);

    const { title, description } = head;

    const isMD = !!title;

    const uid = _.uniqueId('page_');
    ...
    return `
      <div class="md-page-item" >
        ...
        <input type="checkbox" ${
          !isMD ? 'checked' : ''
        } id="${uid}-delete" class="md-input-delete" />
        ...
        <div class="md-box" style="${styleStr(styles.box)}">
          ...
          <label class="md-delete delete" for="${uid}-delete" style="${styleStr(
      styles.btn
    )}"></label>
        </div>
      </div>
      ...
      <mj-wrapper background-color="#f7f7f7" padding="20px">
        ...
        <mj-section mj-class="table">
          <mj-column>
            ...
            <mj-text>
              <div class="$dataInfo" id="iwork" contenteditable="true">${
                this.iwork
              }</div>
            </mj-text>
          </mj-column>
        ...
        <mj-section mj-class="table">
          <mj-column>
            <mj-text>
              ...
              <span class="$dataInfo" id="fe-name" contenteditable="true">${
                commit['%cn']
              }</span>
            </mj-text>
          </mj-column>
        ...
        <mj-section mj-class="table">
          <mj-column>
            <mj-text>
              ...
              <span class="$dataInfo" id="test-time" contenteditable="true">${DateFormat(
                { format: `y/m/d` }
              )}</span>
            </mj-text>
          </mj-column>
        ...
        <mj-section mj-class="table table-bottom">
          <mj-column>
            <mj-text>
              ...
              <span class="$dataInfo" id="online-time" contenteditable="true">${DateFormat(
                { format: `y/m/d` }
              )}</span>
            </mj-text>
          </mj-column>
